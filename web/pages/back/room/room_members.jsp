    ...
    <div class="wrap-fluid" style="width: auto; margin-left: 250px;">
        <div class="container-fluid paper-wrap bevel tlbr">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h2 class="tittle-content-header">
                        ...
                        <span style="font-family:'Microsoft YaHei UI';font-size: 25px">寝室人员</span>
                    </h2>
                </div>
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="/pages/back/room/room_list.jsp" title="Sample page 1">选择寝室</a>
                </li>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li><a title="Sample page 1">查看人员</a>
                </li>
                <li class="pull-right">
            ...
            <%--数据搜索结果表单--%>
            <div class="col-md-10">
                <c:if test="${allMembersInRoom != null}">
                    ...
                    <tbody>
                    <c:forEach items="${allMembersInRoom}" var="member">
                        <tr>
                            <td>${member.getMid()}</td>
                            <td>${member.getName()}</td>
                            <td>${member.getEntryYear()}</td>
                            <td>
                                <c:if test="${member.getSex() ==1}">男
                                </c:if>
                                <c:if test="${member.getSex() ==2}">女
                                </c:if>
                            </td>
