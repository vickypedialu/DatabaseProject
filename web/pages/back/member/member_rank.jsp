    ...
    <div class="wrap-fluid" style="width: auto; margin-left: 250px;">
        <div class="container-fluid paper-wrap bevel tlbr">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h2 class="tittle-content-header">
                        <i class="icon-plus"></i>
                        <span style="font-family:'Microsoft YaHei UI';font-size: 25px">学生评分操作</span>
                    </h2>
                </div>
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="/pages/back/member/member_rank.jsp" title="Sample page 1">学生评分</a>
                </li>
                <li class="pull-right">
            ...
            <div class="row" style="margin-top:30px;padding:0 15px;">
                <div class="col-sm-8">
                    ...
                    <%--数据增加表单--%>
                        <form action="/pages/back/member/MemberServlet/Rank" method="get">
                            <c:if test="${allMembers != null}">
                                <div class="form-group">
                                    <label for="mid" class="col-md-2 control-label" style="font-family:'Microsoft YaHei UI';font-size: 15px">选择学生</label>
                                    <div class="col-md-4">
