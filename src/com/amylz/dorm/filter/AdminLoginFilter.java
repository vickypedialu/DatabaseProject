...
@WebFilter(filterName = "AdminLoginFilter",urlPatterns = {"/pages/back/index.jsp","/pages/back/item/*"
        ,"/pages/back/member/*","/pages/back/getserv/*","/pages/back/services/*"
})
